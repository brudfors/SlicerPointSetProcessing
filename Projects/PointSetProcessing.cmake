...
if((EXISTS "${USE_External_PointSetProcessing_BIN_DIR}" AND IS_DIRECTORY "${USE_External_PointSetProcessing_BIN_DIR}")
          AND (EXISTS "${USE_External_PointSetProcessing_SRC_DIR}" AND IS_DIRECTORY "${USE_External_PointSetProcessing_SRC_DIR}"))

    message(STATUS "Using Slicer from ${USE_External_PointSetProcessing_BIN_DIR}")


    set(${PROJECT_NAME}_${EP_NAME}_DIR "${USE_External_PointSetProcessing_BIN_DIR}" CACHE INTERNAL "")
  ...
  set(${PROJECT_NAME}_${EP_NAME}_DIR "${USE_External_PointSetProcessing_BIN_DIR}" CACHE INTERNAL "")
  set(${PROJECT_NAME}_${EP_NAME}_INCLUDE_DIR "${USE_External_PointSetProcessing_SRC_DIR}" CACHE INTERNAL "")
  ...
  set(${PROJECT_NAME}_${EP_NAME}_INCLUDE_DIR "${PROJECT_BINARY_DIR}/${EP_NAME}" CACHE INTERNAL "")
