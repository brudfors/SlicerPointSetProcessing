...
if(EXISTS "${USE_External_Slicer_DIR}" AND IS_DIRECTORY "${USE_External_Slicer_DIR}")
    ...
    message(STATUS "Using Slicer from ${USE_External_Slicer_DIR}")


    set(${PROJECT_NAME}_${EP_NAME}_DIR "${USE_External_Slicer_DIR}" CACHE INTERNAL "")
  ...
  list(APPEND EP_CMAKE_ARGS
    ...
    -DSuperBuild_CMakeAll_DIR:PATH=${CMakeAll_DIR}
    -DSuperBuild_PATCH_CTK:FILEPATH=${PROJECT_SOURCE_DIR}/Projects/CTK.patch
    -DSuperBuild_PROJECT_VERSION:STRING=${${PROJECT_NAME}_VERSION_MAJOR}.${${PROJECT_NAME}_VERSION_MINOR})
